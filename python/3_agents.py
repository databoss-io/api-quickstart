...
agents = requests.get(f"https://api-prod.databoss.io/v1/organization/{ORGANIZATION_ID}/agent", headers={
    "Authorization": f"Bearer {access_token}"
})
agents.raise_for_status()
agents_resp = agents.json()

# Final output ----------------------------------------------------------------

print("\r\n****** Associated Agents *******")
print(json.dumps(agents_resp.get('result'), indent=2))
print("***********************")